    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_continue.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                btn_continue.setTextColor( Color.RED );

                //menyimpan data kepada lokal hp
                ...
                // berpindah activity
                Intent gotonextregister = new Intent( RegisterOneAct.this,register_two.class );
        ...
        btn_back.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent gotoregisterone = new Intent( RegisterOneAct.this,SignInAct.class );
