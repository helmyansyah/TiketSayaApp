...
public class EditProfileAct extends AppCompatActivity {
   ...
   EditText xusername,xbio, xnama_lengkap,xpassword,xemail_addres;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xemail_addres = findViewById( R.id.xemail_address );
        ...
        reference.addValueEventListener( new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                xemail_addres.setText( dataSnapshot.child( "email_address" ).getValue().toString() );
            ...
            public void onClick(View view) {
                ...
                reference.addListenerForSingleValueEvent( new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        dataSnapshot.getRef().child( "email_address" ).setValue( xemail_addres.getText().toString() );
                    }
                ...
                // validaasi untuk file apakah ada?
                if (photo_location != null){
                    ...
                    storageReference1.putFile( photo_location )
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            ...
                            //berpindah activity
                            //     Intent gotosucces = new Intent( register_two.this,SuccesRegisterAct.class );
