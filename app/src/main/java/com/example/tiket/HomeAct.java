...
public class HomeAct extends AppCompatActivity {
    ...
    LinearLayout btn_ticket_pisa, btn_ticket_torri, btn_ticket_pagoda,
                 btn_ticket_monas, btn_ticket_candi, btn_ticket_sphink;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_ticket_sphink = findViewById( R.id.btn_ticket_sphink );
        ...
        reference.addListenerForSingleValueEvent( new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                user_balance.setText("$ " + dataSnapshot.child( "user_ballance" ).getValue().toString() );
        ...
        btn_ticket_pisa.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent gototicketpisa = new Intent( HomeAct.this, TiketDetailAct.class );
        ...
        btn_ticket_sphink.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent gototicketpisa = new Intent( HomeAct.this, TiketDetailAct.class );
                // meletakkan data pada intent
                gototicketpisa.putExtra( "jenis_tiket","Sphinks" );
                startActivity( gototicketpisa );
            }
        } );
